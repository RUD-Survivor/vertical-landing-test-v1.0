...
layout (set = 0, binding = 3) uniform texture2D inCloudFogReconstructionTexture;
...
void main()
{
    ...
    vec4 fogColor = texture(sampler2D(inCloudFogReconstructionTexture, linearClampEdgeSampler), sunUv);
