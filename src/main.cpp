...
int main() {
  ...
  // =========================================================
  // 游戏主状态机循环 (Main State Machine Loop)
  // 游戏在这里切换不同的“阶段”：主菜单 -> 航天局/工厂 -> 火箭建造 -> 飞行模拟
  ...
  //==================================================================
      ...
      if (menu_choice == MenuSystem::MENU_NONE || glfwWindowShouldClose(window)) {
          continue; // 如果玩家退出了，重新回到最外层的状态机（主菜单）。
      }
